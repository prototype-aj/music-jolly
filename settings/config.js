module.exports = {
  TOKEN: process.env.TOKEN || "MTA1NjY1MzgzNjk3MTk0MTkyOA.GFLiBi.WuW4aP-EhMEuL5jYRWEkLtndo0MT6lGJNZcffk",
  PREFIX: process.env.PREFIX || "PREFIX",
  embed: {
    color: process.env.color || "#220f80",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "Coded By Prototype AJ",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  // others
  mongodb: process.env.MONGO_URL || "mongodb+srv://Music_Jolly:Music_Jolly@cluster01.v1pidms.mongodb.net/?retryWrites=true&w=majority",
  filters: {
  ...
  links: {
    inviteURL:
      ...
      `https://discord.com/api/oauth2/authorize?client_id=1056653836971941928&permissions=8&scope=bot%20applications.commands`,
    DiscordServer: process.env.DiscordServer || `https://discord.gg/zDZ9ZfXVvg`,
    VoteURL: process.env.VoteURL || `https://discord.gg/zDZ9ZfXVvg`,
    Website: `https://discord.gg/zDZ9ZfXVvg`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true,
  ...
  slash: {
    global: true,
    guildID: process.env.GUILD_ID || "1030731784566091786", // for slash command
  },
};
